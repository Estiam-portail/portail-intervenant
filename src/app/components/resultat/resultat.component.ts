...
export class ResultatComponent implements OnInit {
    ...
    uid
    constructor(public resultService: ResultatsService,
        ...
        } else if (this.resultService.Calcul > 5 && this.resultService.Calcul <= 13) {
            this.DCalcul = 2
            localStorage.setItem("DCalcul", JSON.stringify(this.DCalcul))
        } else {
            this.DCalcul = 3
        ...
        } else if (this.resultService.REspace > 6 && this.resultService.REspace <= 8) {
            this.DREspace = 2
            localStorage.setItem("DREspace", JSON.stringify(this.DREspace))
        } else {
            this.DREspace = 3
        ...
        } else if (this.resultService.RTemps > 6 && this.resultService.RTemps <= 10) {
            this.DRTemps = 2
            localStorage.setItem("DRTemps", JSON.stringify(this.DRTemps))
        } else {
            this.DRTemps = 3
        ...
        if (this.resultService.Numerique >= 0 && this.resultService.Numerique <= 5) {
            this.DNumerique = 1
            localStorage.setItem("DNumerique", JSON.stringify(this.DNumerique))
        } else if (this.resultService.Numerique > 5 && this.resultService.Numerique <= 9) {
            this.DNumerique = 2
            localStorage.setItem("DNumerique", JSON.stringify(this.DNumerique))
        } else {
            this.DNumerique = 3
    ...
    enregestrerlesresultat() {
       ...
       console.log('uid local strog : ', uid);
        ...
        this.resultService.result(results).then(res => {
